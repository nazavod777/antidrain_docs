...
description: Простое объяснение rescue-сценариев и пошаговый путь для спасения активов без сложного web3-жаргона.
---
...
Выберите **Remove Delegation**, если сайт показывает активное [делегирование EIP-7702](/ru/glossary#delegirovanie-eip-7702) и вам нужно его убрать. Это отключает делегированный код, но не делает старый приватный ключ безопасным.

Выберите **Custom TX Builder**, если вы точно знаете, какой токен или NFT нужно отправить, и у вас есть адрес контракта, получатель и сумма.
...
Выберите **Permit Rescue**, если токен поддерживает [permit](/ru/glossary#permit) и сайт может подготовить подпись. Это подходит не всем токенам.
...
Сумму видно до отправки, на шаге Fund Donor. Разбор всех случаев — на странице [Комиссии сервиса](/ru/service-fees).
