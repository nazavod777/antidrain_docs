require(['gitbook', 'jquery'], function(gitbook, $) {
    function assetPath(fileName) {
        ...
        return basePath + '/gitbook/gitbook-plugin-docs-header/' + fileName;
    }
    ...
    function bindSocialLinks() {
        ...
        if ($links.length === 0) {
            ...
            $links.append(
                socialLink('Telegram', 'https://t.me/bio_nazavod', 'fa fa-telegram'),
                socialLink('X.com', 'https://x.com/nazavod777', null, 'X'),
    ...
    function socialLink(label, href, iconClass, text, imageSrc) {
        var $link = $('<a>', {
